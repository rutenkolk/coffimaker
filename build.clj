...
(def lib-coord 'wiredaemon/coffimaker)
...
(def jar-file (str target-dir "coffimaker.jar"))
...
(defn- write-pom "Writes a pom file" [opts]
  (b/write-pom {:basis basis
                ...
                :lib lib-coord
                :version version
                :scm {:url "https://github.com/rutenkolk/coffimaker"
                      :connection "scm:git:git://github.com/rutenkolk/coffimaker.git"
                      :developerConnection "scm:git:ssh://git@github.com/rutenkolk/coffimaker.git"
                      :tag (str "v" version)}
...
(defn jar
  "Generates a `coffimaker.jar` file in the `target/` directory"
  [opts]
  (write-pom opts)
  (copy-resources opts)
